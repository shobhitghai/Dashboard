var constants = function() {
    this.obj = {
        ...
        /* port 3000 is for local dev, use 80 on prod env */
        port: 3000,
        // port: 80,


        /* localhost is for local machine, uncomment server domain for prod env. */
        redirect_uri: "http://localhost:3000/monitoring/auth_token",
